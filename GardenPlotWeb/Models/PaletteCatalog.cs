...
public static class PaletteCatalog
{
    ...
    [
        new("Sprinkler 12' Full", PaletteKind.IrrigationHead, 24.0, 24.0, "sprinkler-full", Notes: "12 ft throw, 360°", StrokeColor: "#1f6f8b", FillColor: "#5fb0cf"),
        new("Sprinkler 15' Full", PaletteKind.IrrigationHead, 30.0, 30.0, "sprinkler-full", Notes: "15 ft throw, 360°", StrokeColor: "#1f6f8b", FillColor: "#5fb0cf"),
        new("Sprinkler 20' Full", PaletteKind.IrrigationHead, 40.0, 40.0, "sprinkler-full", Notes: "20 ft throw, 360°", StrokeColor: "#1f6f8b", FillColor: "#5fb0cf"),
        new("Sprinkler 15' Quarter", PaletteKind.IrrigationHead, 30.0, 30.0, "sprinkler-quarter", Notes: "15 ft throw, 90°", StrokeColor: "#1f6f8b", FillColor: "#9bd1e0"),
        new("Drip Emitter", PaletteKind.IrrigationHead, 1.0, 1.0, "drip-emitter", Notes: "point emitter, ~1 ft wetted radius", StrokeColor: "#2a4d6a", FillColor: "#8ac4d8"),
    ];

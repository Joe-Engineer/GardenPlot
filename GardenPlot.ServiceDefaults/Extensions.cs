// <copyright file="Extensions.cs" company="Garden Plot">
...
public static class Extensions
{
    ...
    {
        // Adding health-check endpoints to applications in non-development environments has security implications.
